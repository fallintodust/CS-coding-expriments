...
int main() {
    ...
    benchmark_sort(quick_sort_opt, "优化快速排序", original_data, ARRAY_SIZE);
    benchmark_sort(heap_sort, "堆排序", original_data, ARRAY_SIZE);
    benchmark_sort(heap_sort_opt, "优化堆排序", original_data, ARRAY_SIZE);
